...
cshift_t	cshift_water = { {0,0,255}, 128 };
...
// Entar - new gun movement code
cl.viewent.angles[ROLL] -= v_idlescale.value * sin(cl.time*v_iroll_cycle.value) * v_iroll_level.value + sin(cl.time*2);
cl.viewent.angles[PITCH] -= v_idlescale.value * sin(cl.time*v_ipitch_cycle.value) * v_ipitch_level.value;
cl.viewent.angles[YAW] -= v_idlescale.value * sin(cl.time*v_iyaw_cycle.value) * v_iyaw_level.value + sin(cl.time*2);
// Entar - end new code
}
